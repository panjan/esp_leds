      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /next") >= 0) {
              Serial.println("Next effect");
              nextPattern();
            } else if (header.indexOf("GET /color/cycle/on") >= 0) {
              Serial.println("Cycle colors on");
              cycleColors = "on";
              gHue++;
            } else if (header.indexOf("GET /color/cycle/off") >= 0) {
            ...
            if (cycleColors=="off") {
              ...
              client.println("<p><a href=\"/color/cycle/off\"><button class=\"button\">Cycle colors</button></a></p>");
            }
